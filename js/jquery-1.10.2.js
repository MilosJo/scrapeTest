...
(function (e) {
    e.alerts = {
        ...
        _show: function (t, n, r, i, s) {
            ...
            e("BODY").append('<div id="popup_container">' + '<h1 id="popup_title"></h1>' + '<div id="popup_content">' + '<div id="popup_message"></div>' + "</div>" + "</div>");
            ...
            switch (i) {
                case "alert":
                    e("#popup_message").after('<div id="popup_panel"><input type="button" value="' + e.alerts.okButton + '" id="popup_ok" /></div>');
                ...
                case "prompt":
                    //viyuta
                    //e("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" maxlength="' + ((typeof TechAnalysisMaxLimit == 'undefined') ? "2" : TechAnalysisMaxLimit.toString().length) + '"/><BR/><span id="popup_validation_message" style="color:red;display:none;">' + ((typeof term_PopupMessage == 'undefined') ? "Please enter value within range 1 to 99." : term_PopupMessage) + '<span>').after('<div id="popup_panel"><input type="button" value="' + e.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + e.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    e("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" /><BR/><span id="popup_validation_message" style="color:red;display:none;"><span>').after('<div id="popup_panel"><input type="button" value="' + e.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + e.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    e("#popup_prompt").width(e("#popup_message").width());
                    e("#popup_ok").click(function (eve) {
                        eve.preventDefault();
                        var t = e("#popup_prompt").val();
                        var isValid = false;
                        //var limit = (typeof TechAnalysisMaxLimit == 'undefined') ? 99 : TechAnalysisMaxLimit;
                        var limit = 99;
                        if (r) {
                            limit = r.split(':')[2];
                        }
                        if (parseInt(t) >= 1 && parseInt(t) <= limit)
                            isValid = true;
                        if (isValid) {
                            e.alerts._hide();
                            if (s) s(t)
                            e("#popup_validation_message").css('display', 'none');
                        }
                        else { e("#popup_validation_message").css('display', ''); }
                    });
                    e("#popup_cancel").click(function () {
                        e.alerts._hide();
                        if (s) s(null)
                    });
                    e("#popup_prompt").keyup(function () {
                        this.value = this.value.replace(/[^0-9\.]/g, "")
                    });
                    e("#popup_prompt").keydown(function (t) {
                        if (t.shiftKey || t.ctrlKey || t.altKey) {
                            t.preventDefault()
                        } else {
                            var n = t.keyCode;
                            if (!(n == 8 || n >= 48 && n <= 57 || n >= 96 && n <= 105)) {
                                t.preventDefault()
                            }
                            if (t.keyCode == 13) e("#popup_ok").trigger("click");
                            if (t.keyCode == 27) e("#popup_cancel").trigger("click")
                    ...
                    if (r) {
                        var value = r.split(':');
                        e("#popup_prompt").val(value[0]);
                        e("#popup_prompt").attr("maxlength", value[2].toString().length);
                        e("#popup_validation_message").text(value[1]);
                    }
...
(function () {
    ...
    function e(e) {
        function a(i, a) {
            ...
            var w = a.baseZ;
            var E, S, x, T;
            if (n || a.forceIframe) E = e('<iframe class="blockUI" style="z-index:' + w++ + ';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="' + a.iframeSrc + '"></iframe>');
            else E = e('<div class="blockUI" style="display:none"></div>'); if (a.theme) S = e('<div class="blockUI blockOverlay ui-widget-overlay" style="z-index:' + w++ + ';display:none"></div>');
            else S = e('<div class="blockUI blockOverlay" style="z-index:' + w++ + ';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>'); if (a.theme && m) {
            ...
            if (r || k) {
                ...
                e.each(N, function (e, t) {
                    ...
                    n.position = "absolute";
                    if (e < 2) {
                        if (m) n.setExpression("height", "Math.max(document.body.scrollHeight, document.body.offsetHeight) - (jQuery.support.boxModel?0:" + a.quirksmodeOffsetHack + ') + "px"');
                        else n.setExpression("height", 'this.parentNode.offsetHeight + "px"'); if (m) n.setExpression("width", 'jQuery.support.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"');
                        else n.setExpression("width", 'this.parentNode.offsetWidth + "px"'); if (M) n.setExpression("left", M);
            ...
            if (g) {
                if (a.theme) x.find(".ui-widget-content").append(g);
                else x.append(g); if (g.jquery || g.nodeType) e(g).show()
            }
            ...
            } else d(x[0], a.centerX, a.centerY); if (a.timeout) {
        ...
        function f(t, n) {
            ...
            var h;
            if (i) h = e("body").children().filter(".blockUI").add("body > .blockUI");
            else h = s.find(">.blockUI"); if (n.cursorReset) {
        ...
        function c(t, n, r) {
            ...
            if (t) e(document).bind(u, r, h);
            else e(document).unbind(u, h)
        }
        ...
        function h(t) {
            ...
            var s = t.data;
            var a = e(t.target);
            if (a.hasClass("blockOverlay") && s.onOverlayClick) s.onOverlayClick(t);
...
(function (e) {
    ...
    function r(t) {
        ...
        return t.delegate(n, "mouseout", function () {
            ...
            if (!e.datepicker._isDisabledDatepicker(s.inline ? t.parent()[0] : s.input[0])) {
    ...
    e.extend(n.prototype, {
        ...
        _newInst: function (t, n) {
            ...
            return {
                ...
                drawYear: 0,
                inline: n,
                dpDiv: !n ? this.dpDiv : r(e("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
            }
        },
        ...
        _optionDatepicker: function (t, n, r) {
            var s, o, u, a, f = this._getInst(t);
            if (arguments.length === 2 && typeof n === "string") {
                return n === "defaults" ? e.extend({}, e.datepicker._defaults) : f ? n === "all" ? e.extend({}, f.settings) : this._get(f, n) : null
            }
            s = n || {};
            if (typeof n === "string") {
                s = {};
            ...
            if (f) {
                ...
                o = this._getDateDatepicker(t, true);
                u = this._getMinMaxDate(f, "min");
                a = this._getMinMaxDate(f, "max");
                i(f.settings, s);
                if (u !== null && s.dateFormat !== undefined && s.minDate === undefined) {
                    f.settings.minDate = this._formatDate(f, u)
                }
                if (a !== null && s.dateFormat !== undefined && s.maxDate === undefined) {
                    f.settings.maxDate = this._formatDate(f, a)
                }
                if ("disabled" in s) {
                    if (s.disabled) {
                        this._disableDatepicker(t)
        ...
        _showDatepicker: function (n) {
            ...
            if (n.nodeName.toLowerCase() !== "input") {
                n = e("input", n.parentNode)[0]
            }
            if (e.datepicker._isDisabledDatepicker(n) || e.datepicker._lastInput === n) {
                return
            }
            var r, s, o, u, a, f, l;
            r = e.datepicker._getInst(n);
            if (e.datepicker._curInst && e.datepicker._curInst !== r) {
                e.datepicker._curInst.dpDiv.stop(true, true);
                if (r && e.datepicker._datepickerShowing) {
                    e.datepicker._hideDatepicker(e.datepicker._curInst.input[0])
                }
            }
            s = e.datepicker._get(r, "beforeShow");
            o = s ? s.apply(n, [n, r]) : {};
            if (o === false) {
                return
            }
            ...
            if (!e.datepicker._pos) {
                e.datepicker._pos = e.datepicker._findPos(n);
                e.datepicker._pos[1] += n.offsetHeight
            }
            u = false;
            e(n).parents().each(function () {
                u |= e(this).css("position") === "fixed";
                return !u
            });
            a = {
            ...
            e.datepicker._updateDatepicker(r);
            a = e.datepicker._checkOffset(r, a, u);
            r.dpDiv.css({
            ...
            if (!r.inline) {
                f = e.datepicker._get(r, "showAnim");
                l = e.datepicker._get(r, "duration");
                r.dpDiv.css("z-index", t(e(n)) + 1);
                e.datepicker._datepickerShowing = true;
                if (e.effects && e.effects.effect[f]) {
                    r.dpDiv.show(f, e.datepicker._get(r, "showOptions"), l)
                } else {
                    r.dpDiv[f || "show"](f ? l : null)
                } if (e.datepicker._shouldFocusInput(r)) {
                    r.input.focus()
                }
        ...
        _updateDatepicker: function (t) {
            ...
            if (i > 1) {
                t.dpDiv.addClass("ui-datepicker-multi-" + i).css("width", o * i + "em")
            }
        ...
        _hideDatepicker: function (t) {
            ...
            if (this._datepickerShowing) {
                ...
                if (e.effects && (e.effects.effect[n] || e.effects[n])) {
                    o.dpDiv.hide(n, e.datepicker._get(o, "showOptions"), r, i)
                } else {
                    o.dpDiv[n === "slideDown" ? "slideUp" : n === "fadeIn" ? "fadeOut" : "hide"](n ? r : null, i)
                } if (!n) {
                    i()
                }
                this._datepickerShowing = false;
                ...
                if (s) {
                    s.apply(o.input ? o.input[0] : null, [o.input ? o.input.val() : "", o])
                }
        ...
        _generateHTML: function (e) {
            ...
            for (S = 0; S < V[0]; S++) {
                ...
                for (T = 0; T < V[1]; T++) {
                    ...
                    for (E = 0; E < 7; E++) {
                        A = (E + l) % 7;
                        L += "<th scope='col'" + ((E + l + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + h[A] + "'>" + p[A] + "</span></th>"
                    }
                    k += L + "</tr></thead><tbody>";
